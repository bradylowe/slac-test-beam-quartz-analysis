...
float benchmark_compare_voltage_1b_0(int binWidth = 2){
	...
	qdc[index] = load_files_ped_corrected(pedestal, onePEsig, 1, binWidth, 2, run, 253, 254, 255, 256, 257, 263, 264);
	qdc[index]->SetLineColor(color);
	qdc[index]->SetTitle("Benchmarking 1B (5.5 GeV): no tungsten");
